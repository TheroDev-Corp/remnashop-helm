...
event-payment =
    ...
    Платеж получен, но не удалось выдать подписку. Платеж сохранен как оплаченный, выдача подписки будет автоматически повторяться. Если подписка так и не будет выдана, требуется ручная проверка.
